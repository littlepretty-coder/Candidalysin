...
f1477_group = group[group$fungi=='1477',]
f1477_data = data[,rownames(f1477_group)]

f1477_data <- f1477_data[rowMeans(f1477_data)>1,] 
fix(f1477_group)
#################################################################


dds <- DESeqDataSetFromMatrix(countData = f1477_data, colData = f1477_group, design = ~ time)
colData_yeast<-data.frame(time=factor(f1477_group$time),levels=c("0h","3h","6h",'6hc'))
pre_dds_glab <- DESeqDataSetFromMatrix(f1477_data, colData=colData_yeast, ~time)
...
write.table(res_cglab_0_3, file="E:/projects/王秀丽/results/fungi/human/res_1477_0_vs_3.txt", sep = "\t", quote = FALSE)

res_cglab_0_6 <- results(dds_glab, cooksCutoff=FALSE, contrast = c("time","6h","0h"))
write.table(res_cglab_0_6, file="E:/projects/王秀丽/results/fungi/human/res_1477_0_vs_6.txt", sep = "\t", quote = FALSE)
...
write.table(all_data_cglab,"E:/projects/王秀丽/results/fungi/human/res_1477.txt", sep = "\t", quote = FALSE)
...
pdf('E:/projects/王秀丽/results/fungi/human/1477_dyn.pdf',  width=5, heigh=3)
...
genes_glab_0_24<-rownames(res_cglab_0_24[!is.na(res_cglab_0_24$padj) & res_cglab_0_24$padj<0.01,])
overlap<-as.data.frame(Reduce(intersect,list(genes_glab_0_12,genes_glab_0_24)))


venn.diagram(list("1477_0_6"=genes_glab_0_12,
                  "1477_0_6hc"=genes_glab_0_24),
             ...
             filename="E:/projects/王秀丽/results/human/1477_6_6c.png",  
             imagetype = "png")

only_infection_cglab<-setdiff(genes_glab_0_12, genes_glab_0_24)
res_cglab_inf_spec<-res_cglab_0_12[only_infection_cglab,]
write.table(res_cglab_inf_spec,"E:/projects/王秀丽/results/human/infection_genes_1477_6_6c.txt", quote = FALSE, sep = "\t")
...
dds <- DESeqDataSetFromMatrix(countData = f1477_data, colData = f1477_group, design = ~ time)
colData_yeast<-data.frame(time=factor(f1477_group$time),levels=c("0h","3h","12h",'12hc'))
pre_dds_glab <- DESeqDataSetFromMatrix(f1477_data, colData=colData_yeast, ~time)
dds_glab <- DESeq(pre_dds_glab)

##### all compared with 0 time point########
res_cglab_0_3 <- results(dds_glab, cooksCutoff=FALSE, contrast = c("time","3h","0h"))
write.table(res_cglab_0_3, file="E:/projects/王秀丽/results/fungi/mouse/res_1477_0_vs_3.txt", sep = "\t", quote = FALSE)

res_cglab_0_12 <- results(dds_glab, cooksCutoff=FALSE, contrast = c("time","12h","0h"))
write.table(res_cglab_0_12, file="E:/projects/王秀丽/results/fungi/mouse/res_1477_0_vs_12.txt", sep = "\t", quote = FALSE)

res_cglab_0_12c <- results(dds_glab, cooksCutoff=FALSE, contrast = c("time","12hc","0h"))
write.table(res_cglab_0_12c, file="E:/projects/王秀丽/results/fungi/mouse/res_1477_0_vs_12c.txt", sep = "\t", quote = FALSE)

all_data_cglab<-cbind.data.frame(res_cglab_0_3$log2FoldChange,res_cglab_0_3$padj,
                                 res_cglab_0_12$log2FoldChange,res_cglab_0_12$padj)
write.table(all_data_cglab,"E:/projects/王秀丽/results/fungi/mouse/res_1477.txt", sep = "\t", quote = FALSE)
...
pdf('E:/projects/王秀丽/results/fungi/mouse/1477_dyn.pdf',  width=5, heigh=3)
ggplot(data=LFC_plotting_inter, aes(x=LFC_plotting_inter$Var2, y=LFC_plotting_inter$value, group=LFC_plotting_inter$Var1, colour=LFC_plotting_inter$value)) +
  geom_line() + xlab("Time (h)")+ylab("Log 2 fold change") + 
  scale_colour_gradient2(low = "blue", mid = "grey", high = "red",limits = c(-30,30),space = "Lab",na.value = "grey50", guide = "colourbar")+theme_bw()+
  labs(colour = "L2FC\ngradient")+
...
venn.diagram(list("1477_0_12"=genes_glab_0_12,
                  "1477_0_12c"=genes_glab_0_12c),
             fill=c("green", "cornflowerblue"), height = 2500, width = 2500, resolution = 600, 
             main = "C. glabrata DE genes between 6h and 6h control", cat.cex=0.4, cex=1.8, main.cex = 0.7, 
             filename="E:/projects/王秀丽/results/fungi/1477_12_12c.png",  
             imagetype = "png")

only_infection_cglab<-setdiff(genes_glab_0_12, genes_glab_0_12c)
res_cglab_inf_spec<-res_cglab_0_12[only_infection_cglab,]
write.table(res_cglab_inf_spec,"E:/projects/王秀丽/results/fungi/mouse/infection_genes_1477_6_6c.txt", quote = FALSE, sep = "\t")
...
f1477_group = group[group$fungi%in%c('1477','CTL'),]
f1477_data = human_controls[,f1477_group$samples]

f1477_data <- f1477_data[rowMeans(f1477_data)>1,] 
fix(f1477_group)
write.table(group,'human_group.txt',sep='\t')
f1477_group = read.delim('./data/human_group.txt')
#all_human_data<-cbind.data.frame("1"=human_controls$`1`, "2"=human_controls$`2`, human, "17"=human_controls$`17`, "18"=human_controls$`18`) 
all_human_data = f1477_data
### DESEQ2 ###

colData_human<-data.frame(time=factor(f1477_group$time,levels=c("0h","3h","6h",'6hc')))
...
write.table(res_cglab_human_0_3, file="E:/projects/王秀丽/results/human/res_human_1477_0_vs_3.txt", sep = "\t", quote = FALSE)
res_cglab_human_0_3 = read.delim("E:/projects/王秀丽/3-14/results/human/1477/res_human_1477_0_vs_3.txt")
res_cglab_human_0_6 <- results(dds_human, cooksCutoff=FALSE, contrast = c("time","6h","0h"))
write.table(res_cglab_human_0_6, file="E:/projects/王秀丽/results/human/res_human_1477_0_vs_6.txt", sep = "\t", quote = FALSE)
res_cglab_human_0_6 = read.delim("E:/projects/王秀丽/3-14/results/human/1477/res_human_1477_0_vs_6.txt")
res_cglab_human_0_6c <- results(dds_human, cooksCutoff=FALSE, contrast = c("time","6hc","0h"))
write.table(res_cglab_human_0_6c, file="E:/projects/王秀丽/results/human/res_human_1477_0_vs_6hc.txt", sep = "\t", quote = FALSE)
res_cglab_human_0_6c = read.delim("E:/projects/王秀丽/3-14/results/human/1477/res_human_1477_0_vs_6hc.txt")
...
library(ggplot2)
pdf('E:/projects/王秀丽/results/human/human_1477_dyn.pdf', units="in", width=5, heigh=2.5, res=400)
ggplot(data=LFC_plotting_inter, aes(x=LFC_plotting_inter$Var2, y=LFC_plotting_inter$value, group=LFC_plotting_inter$Var1, colour=LFC_plotting_inter$value)) +
...
ggsave('E:/projects/王秀丽/results/human/human_1477_dyn.pdf', width=5, heigh=2.5)


genes_glab_0_3<-rownames(res_cglab_human_0_3[!is.na(res_cglab_human_0_3$padj) & res_cglab_human_0_3$padj<0.01,])
genes_glab_0_6<-rownames(res_cglab_human_0_6[!is.na(res_cglab_human_0_6$padj) & res_cglab_human_0_6$padj<0.01,])
overlap<-as.data.frame(Reduce(intersect,list(genes_glab_0_3,genes_glab_0_6)))

library(VennDiagram)
venn.diagram(list("1477_0_3"=genes_glab_0_3,
                  "1477_0_6"=genes_glab_0_6),
             fill=c("green", "cornflowerblue"), height = 2500, width = 2500, resolution = 600, 
             main = "C. glabrata DE genes between 6h and 6h control", cat.cex=0.4, cex=1.8, main.cex = 0.7, 
             #filename="E:/projects/王秀丽/results/human/1477_3_6.pdf",  
             imagetype = "png")
...
colData_human<-data.frame(time=factor(f1477_group$time,levels=c("0h","3h","12h",'12hc')))
pre_dds_human <- DESeqDataSetFromMatrix(all_human_data, colData=colData_human, ~time)
dds_human <- DESeq(pre_dds_human)

##### all compared with 0 time point########
res_cglab_human_0_3 <- results(dds_human, cooksCutoff=FALSE, contrast = c("time","3h","0h"))
write.table(res_cglab_human_0_3, file="E:/projects/王秀丽/results/mouse/res_mouse_1477_0_vs_3.txt", sep = "\t", quote = FALSE)
res_cglab_human_0_3 = read.delim("E:/projects/王秀丽/3-14/results/mouse/1477/res_mouse_1477_0_vs_3.txt")
res_cglab_human_0_12 <- results(dds_human, cooksCutoff=FALSE, contrast = c("time","12h","0h"))
write.table(res_cglab_human_0_12, file="E:/projects/王秀丽/results/mouse/res_mouse_1477_0_vs_12.txt", sep = "\t", quote = FALSE)
res_cglab_human_0_12 = read.delim("E:/projects/王秀丽/3-14/results/mouse/1477/res_mouse_1477_0_vs_12.txt")
res_cglab_human_0_12c <- results(dds_human, cooksCutoff=FALSE, contrast = c("time","12hc","0h"))
write.table(res_cglab_human_0_12c, file="E:/projects/王秀丽/results/mouse/res_mouse_1477_0_vs_12hc.txt", sep = "\t", quote = FALSE)
res_cglab_human_0_12c = read.delim("E:/projects/王秀丽/3-14/results/mouse/1477/res_mouse_1477_0_vs_12hc.txt")
#########Plotting of interpolated LFC #####################
all_data<-cbind.data.frame(res_cglab_human_0_3$log2FoldChange,res_cglab_human_0_3$padj,
...
png('E:/projects/王秀丽/results/mouse/mouse_1477_dyn.png', units="in", width=5, heigh=2.5, res=400)
ggplot(data=LFC_plotting_inter, aes(x=LFC_plotting_inter$Var2, y=LFC_plotting_inter$value, group=LFC_plotting_inter$Var1, colour=LFC_plotting_inter$value)) +
  geom_line() + xlab("Time (h)")+ylab("Log2 fold change") + 
  scale_colour_gradient2(low = "blue", mid = "grey", high = "red",limits = c(-30,30),space = "Lab",na.value = "grey50", guide = "colourbar")+theme_bw()+labs(colour = "L2FC\ngradient")+
  theme(axis.text = element_text(size = 14),axis.title = element_text(size=14),
...
ggsave('E:/projects/王秀丽/results/mouse/mouse_1477_dyn.pdf',width=5, heigh=2.5)
